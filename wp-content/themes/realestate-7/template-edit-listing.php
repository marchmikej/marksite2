    			...
    			<form action="" id="primaryPostForm" class="front-end-form" method="POST" enctype="multipart/form-data">
                    ...
                    <fieldset class="col span_10 first form-section">
                        ...
                        <div class="input-full-width">
                            ...
                            <input type="text" name="postTitle" id="postTitle" value="<?php echo esc_attr($title); ?>" required />
                        </div>
                    ...
                    <fieldset class="col span_10 first form-section">
                        ...
                        <div class="input-full-width">
                            ...
                            <input type="text" name="pac-input" id="pac-input" value="<?php echo esc_html($title); ?> <?php echo esc_attr($ct_city); ?> <?php echo esc_attr($ct_state); ?> <?php echo esc_attr($ct_zip); ?> <?php if(!empty($ct_country)) { echo esc_attr($ct_country); } ?>" placeholder="<?php _e('Type in an address', 'contempo'); ?>" />
                        </div>
                        ...
                        <div class="col span_6 first">
                            ...
                            <input type="text" name="customTaxCountry" id="customTaxCountry" value="<?php echo esc_attr($ct_country); ?>"/>
                        </div>

                        <div class="col span_6">
                            <label><?php ct_community_neighborhood_or_district(); ?></label>
                            <input type="text" name="customTaxCommunity" id="customTaxCommunity" value="<?php echo esc_attr($ct_community); ?>"/>
                        </div>

                        <div class="col span_12 first">
                            <input type="text" name="customMetaLatLng" id="customMetaLatLng"  placeholder="<?php esc_html_e('Latitude & Longitude (optional)', 'contempo'); ?>" value="<?php echo esc_attr($ct_latlng); ?>" />
                        </div>
