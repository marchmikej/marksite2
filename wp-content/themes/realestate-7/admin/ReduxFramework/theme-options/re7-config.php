<?php
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            ...
            array (
                'desc' => 'Choose if you would like the header to be transparent this applies to the homepage and normal pages with image header backgrounds.',
                'id' => 'ct_trans_header',
                'type' => 'select',
                'options' => array (
                    'yes' => 'Yes',
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            ...
            array (
                'desc' => 'Select whether you\'d like to use Community, Neighborhood, Suburb, District or Building.',
                ...
                'title' => 'Community, Neighborhood, Suburb, District or Building?',
                'default' => 'community',
            ),
    ...
    Redux::setSection( $opt_name, array(
        'title'            => __( 'Yelp', 'contempo' ),
        'id'               => 'yelp',
        'icon'             => 'fa fa-yelp',
        'desc'   => __( 'Set this up if you\'d like to display "What\'s Nearby?" information on your listings such as restaurants, grocery stores, schools, coffee shops, etc&hellip;. Also the "Contempo Payment Gateways" plugin needs to be installed and activated as it includes the required OAuth class.', 'contempo' ),
        'customizer_width' => '450px',
        'fields'           => array(
            array (
                'id' => 'yelp-app-info',
            ...
            array (
                'desc' => 'Enter your Yelp App Secret Key here, don\'t have one get one <a href="https://www.yelp.com/developers/v3/manage_app" target="_blank">here</a>.',
                'id' => 'ct_yelp_app_secret_key',
                'type' => 'text',
                'title' => 'Yelp App Secret',
                'default' => '',
            ),
            /*
            array (
                'desc' => 'Enter your Yelp Consumer Key here, don\'t have one get one <a href="https://www.yelp.com/developers/v2/manage_api_keys" target="_blank">here</a>.',
                'id' => 'ct_yelp_consumer_key',
                'type' => 'text',
                'title' => 'Yelp Consumer Key',
                'default' => '',
            ),
            array (
                'desc' => 'Enter your Yelp Consumer Secret Key here, don\'t have one get one <a href="https://www.yelp.com/developers/v2/manage_api_keys" target="_blank">here</a>.',
                'id' => 'ct_yelp_consumer_secret_key',
                'type' => 'text',
                'title' => 'Yelp Consumer Secret Key',
                'default' => '',
            ),
            array (
                'desc' => 'Enter your Yelp Token Key here, don\'t have one get one <a href="https://www.yelp.com/developers/v2/manage_api_keys" target="_blank">here</a>.',
                'id' => 'ct_yelp_token_key',
                'type' => 'text',
                'title' => 'Yelp Token Key',
                'default' => '',
            ),
            array (
                'desc' => 'Enter your Yelp Token Secret Key here, don\'t have one get one <a href="https://www.yelp.com/developers/v2/manage_api_keys" target="_blank">here</a>.',
                'id' => 'ct_yelp_token_secret_key',
                'type' => 'text',
                'title' => 'Yelp Token Secret Key',
                'default' => '',
            ),*/
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array(
            ...
            array (
                ...
                <p>Below are some of my personal recommendations, my own <strong><a href="http://contempothemes.com/wp-real-estate-7/hosting/">Contempo Managed WordPress Hosting</a></strong> is setup specifically for my themes, is powered by AWS with 24/7 specialized support. The other providers are also great and come highly recommended.</p>
                <ol>
