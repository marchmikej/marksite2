				...
				<div class="panels">
					...
					<div id="panel" class="panel">
						...
						<div id="support-panel" class="panel-left">
							...
							<h3><?php printf( __( 'Where do I get support for %s', 'contempo' ), $theme['Name'] ); ?></h3>

							<p><?php
								$ct_documentation_url = admin_url('admin.php?page=WPProRealEstate7&tab=1');
								$ct_support_url = 'https://contempo.ticksy.com/';
								...
								printf( __( 'If you\'ve read through the <a href="%1$s" target="_blank">documentation</a> and still have questions or are experiencing issues, I\'m happy to help! Simply <a href="%2$s"  target="_blank" title="Open a support ticket">open a support ticket</a> and I\'ll personally get back to you, thanks in advance for your patience. If its an urgent smaller matter please <a href="%3$s" target="_blank">leave a comment</a> on the item page.', 'contempo' ), esc_url( $ct_documentation_url ), esc_url( $ct_support_url ), esc_url( $ct_item_comments_url ) );
							?></p>
								...
								<p>
									<em>
										<?php
											...
											$ct_support_url = 'https://contempo.ticksy.com/';
											$ct_item_comments_url = 'https://themeforest.net/item/wp-pro-real-estate-7-responsive-real-estate-wordpress-theme/12473778/comments?ref=contempoinc';
											printf( __( 'Please note that support requests will not be answered via email, only through my <a href="%1$s" target="_blank">dedicated support site</a> or within the <a href="%2$s" target="_blank">item comments</a>.', 'contempo' ), esc_url( $ct_documentation_url ), esc_url( $ct_support_url ), esc_url( $ct_item_comments_url ) );
										?>
									</em>
								</p>
