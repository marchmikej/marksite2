...
if(!function_exists('ct_init_scripts')) {
	function ct_init_scripts() {
		...
		if(is_single() || is_author() || is_page_template('template-contact.php') || is_page_template('template-submit-listing.php') || is_front_page() || is_page_template('template-agents.php') || is_page_template('template-brokerages.php')) {
...
if(!function_exists('ct_wp_head')) {
	function ct_wp_head() {
		...
		/*-----------------------------------------------------------------------------------*/
		/* Custom Google Fonts & iHomeFinder CSS */
		/*-----------------------------------------------------------------------------------*/
		...
		echo '<style type="text/css">';
			...
			if ( is_plugin_active( 'optima-express/iHomefinder.php' ) ) {
				...
				echo '#searchProfile .customSelect, #ihf-main-search-form .customSelect { display: none !important;}';
				...
				echo '.ihf-widget .customSelect { display: none !important;}';
			}
			include_once ABSPATH . 'wp-admin/includes/plugin.php';
...
function ct_expire_listings() {
	...
	if($ct_enable_front_end_paid == 'yes' && $author_level <= '2' && $ct_listing_expiration != '') {
...
if(!function_exists('ct_search_results_map_navigation')) {
	function ct_search_results_map_navigation() {
	    echo '<div id="ct-map-navigation">';
	        echo '<button id="ct-gmap-prev" class="map-btn"><i class="fa fa-chevron-left"></i> <span>Prev</span></button>';
	        echo '<button id="ct-gmap-next" class="map-btn"><span>Next</span> <i class="fa fa-chevron-right"></i></button>';
	    echo '</div>';
...
if(!function_exists('ct_community_neighborhood_or_district')) {
	function ct_community_neighborhood_or_district() {
		...
		echo esc_html(ucfirst($ct_community_neighborhood_or_district)); 
	}
}
...
// Credentials
$CLIENT_ID = 't8q2AoD941KZBlIJ699iTg';
$CLIENT_SECRET = 'NF1H6XTxe6NlvKvg8Z6yLEP7dD8hHePFOlqXloJ5qhzpHyRJM6HNusGsQXc9uivj';
...
function obtain_bearer_token() {
    try {
    	...
    	echo '<div class="nomatches">';
	    	echo '<h5>' . __('Yelp API is currently unavailable.', 'contempo') . '</h5>';
	    	echo '<p class="marB0">';
		        echo sprintf(
 ...
 */
function ct_query_yelp_api($term,$location) {      
