        			...
        			<form action="" id="primaryPostForm" class="front-end-form" method="POST" enctype="multipart/form-data">
                        ...
                        <fieldset class="col span_10 first form-section">
                            ...
                            <div class="col span_4">
                                ...
                                <input type="text" name="customMetaSqFt" id="customMetaSqFt" value="<?php if(isset($_POST['customMetaSqFt'])) echo esc_attr($_POST['customMetaSqFt']);?>" required />
                            </div>
                            ...
                            <div id="listing-open-house">
                                ...
                                <div class="col span_4 first">
                                    ...
                                    <input type="text" name="customMetaOpenHouseDate" id="customMetaOpenHouseDate" value="<?php if(isset($_POST['customMetaOpenHouseDate'])) echo esc_attr($_POST['customMetaOpenHouseDate']);?>" />
                                </div>

                                <div class="col span_4">
                                    <label><?php esc_html_e('Start Time', 'contempo'); ?></label>
                                    <input type="text" name="customMetaOpenHouseStartTime" id="customMetaOpenHouseStartTime" value="<?php if(isset($_POST['customMetaOpenHouseStartTime'])) echo esc_attr($_POST['customMetaOpenHouseStartTime']);?>" />
                                </div>

                                <div class="col span_4">
                                    <label><?php esc_html_e('End Time', 'contempo'); ?></label>
                                    <input type="text" name="customMetaOpenHouseEndTime" id="customMetaOpenHouseEndTime" value="<?php if(isset($_POST['customMetaOpenHouseEndTime'])) echo esc_attr($_POST['customMetaOpenHouseEndTime']);?>" />
                                </div>
                        ...
                        <fieldset class="col span_10 first form-section">
                            ...
                            <div class="input-full-width">
                                ...
                                <input type="text" name="pac-input" id="pac-input" value="" placeholder="<?php _e('Type in an address', 'contempo'); ?>" />
                            </div>

                            <div class="col span_4 first">
                                <label><?php esc_html_e('City', 'contempo'); ?></label>
                                <input type="text" name="locality" id="customTaxCity" value="<?php if ( isset( $_POST['customTaxCity'] ) ) echo esc_attr($_POST['customTaxCity']); ?>"/>
                            </div>
                            ...
                            <div class="col span_4">
                                ...
                                <?php } ?>
                                <input type="text" name="administrative_area_level_1" id="customTaxState" value="<?php if ( isset( $_POST['customTaxState'] ) ) echo esc_attr($_POST['customTaxState']); ?>"/>
                            </div>

                            <div class="col span_4">
                                <label><?php ct_zip_or_post(); ?></label>
                                <input type="text" name="postal_code" id="customTaxZip" value="<?php if ( isset( $_POST['customTaxZip'] ) ) echo esc_attr($_POST['customTaxZip']); ?>"/>
                            </div>

                            <div class="col span_6 first">
                                <label><?php esc_html_e('Country', 'contempo'); ?></label>
                                <input type="text" name="country" id="customTaxCountry" value="<?php if ( isset( $_POST['customTaxCountry'] ) ) echo esc_attr($_POST['customTaxCountry']); ?>"/>
                            </div>

                            <div class="col span_6">
                                <label><?php ct_community_neighborhood_or_district(); ?></label>
                                <input type="text" name="customTaxCommunity" id="customTaxCommunity" value="<?php if ( isset( $_POST['customTaxCommunity'] ) ) echo esc_attr($_POST['customTaxCommunity']); ?>"/>
                            </div>

                            <div class="col span_12 first">
                                <input type="text" name="location" id="customMetaLatLng" placeholder="<?php esc_html_e('Latitude & Longitude (optional)', 'contempo'); ?>" value="<?php if(isset($_POST['customMetaLatLng'])) echo esc_attr($_POST['customMetaLatLng']);?>" />
                            </div>
                        ...
                        <fieldset class="col span_10 first form-section">
                            ...
                            <textarea name="customOwnerNotes" id="customOwnerNotes" rows="8" cols="30" placeholder="<?php _e('Write a private note about this listing, this textarea will not be displayed anywhere on the front end of the site.', 'contempo'); ?>">
                                <?php
